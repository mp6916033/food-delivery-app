...
class orderDetails extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String data = bundle.getString("choice_items");
        ...
        show_price_view.setText("INR : " + bdt_price + " TK\n" + "USD : " + usd_price + " $");
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    i.putExtra("address", new String("9999999999"));
