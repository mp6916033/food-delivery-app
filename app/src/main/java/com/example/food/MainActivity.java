...
//button of iteams add
    ...
    public void place_order(View view) {
        ...
        Intent it = new Intent(MainActivity.this, yoo3.class);
        Toast.makeText(this, "ORDER SUCCESSFUL!!!Your food will be delivered shortly", Toast.LENGTH_LONG).show();
    ...
    public void add_to_list(View view) {
        ...
        if (view == findViewById(R.id.haleem_button)) {
            Toast.makeText(this, "Soup Added", Toast.LENGTH_LONG).show();
            hp = hp + 1;
            ...
            Toast.makeText(this, "Biriyani Added", Toast.LENGTH_LONG).show();
    ...
    public void rmv_from_list(View view) {
        ...
        if (view == findViewById(R.id.haleem_button_rm)) {
            ...
            if (fip > 0) {
                ...
                fip = fip - 1;
                firni.setText(Integer.toString(fip));
                Toast.makeText(this, "Sweet dish Removed", Toast.LENGTH_SHORT).show();
            }
            Toast.makeText(this, "Add Items First", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(this, "Add Items First", Toast.LENGTH_SHORT).show();
    ...
    public void balancesheet() {
        ...
        if (bp > 0) {
            choices = choices + "Biriyani       (" + bp + " x 220) = " + tbp;
        }

        if (drp > 0) {
            choices = choices + "\n\nCold Drinks  (" + drp + " x 55) = " + tdrp;
        }

        if (fip > 0) {
            choices = choices + "\n\nSweet dish   (" + fip + " x 40) = " + tfip;
        }

        if (frp > 0) {
            choices = choices + "\n\nFried Rice (" + frp + " x 210) = " + tfrp;
        }
        if (hp > 0) {
            choices = choices + "\n\nSoup    (" + hp + " x 70) = " + thp;
        }
    ...
    public void banner_about(View view) {
        ...
        dialog.setTitle("About this restaurant ");
        dialog.show();
